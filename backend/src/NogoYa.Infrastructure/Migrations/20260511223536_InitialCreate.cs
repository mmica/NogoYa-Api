        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_products_discount_range", "\"DiscountPercent\" >= 0 AND \"DiscountPercent\" <= 100");
                    table.CheckConstraint("ck_products_price_nonneg", "\"Price\" >= 0");
                    table.CheckConstraint("ck_products_stock_nonneg", "\"Stock\" >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_order_items_qty_pos", "\"Quantity\" > 0");
                    table.CheckConstraint("ck_order_items_unit_nonneg", "\"UnitPrice\" >= 0");
                    table.ForeignKey(
